from fynautoserver.services.releases_version_services.releases_version_services import create_releases_version_service, get_releases_version_service,add_custom_tenant_in_version, deploy_tenant_through_azure, check_progress_of_deployment, update_tenant_status_service, deploy_single_tenant_service
