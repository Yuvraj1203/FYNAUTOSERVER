...
from fynautoserver.schemas.index import TenantInfoSchema , AddTenantSchema,Fonts,Color, UserSchema
...
async def init_db():
    try:
        ...
        await init_beanie(database,document_models=[TenantInfoSchema,AddTenantSchema,Fonts,Color,UserSchema])
